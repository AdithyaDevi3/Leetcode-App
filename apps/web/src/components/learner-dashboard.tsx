...
export function LearnerDashboard() {
  ...
  return <main className="min-h-screen bg-slate-50 px-6 py-12 text-slate-900"><section className="mx-auto max-w-3xl rounded-xl bg-white p-8 shadow-sm">
    ...
    {state === 'unauthenticated' ? <div className="mt-6 space-y-3"><p>You need to sign in to view your saved plan.</p><Link className="inline-block rounded bg-slate-900 px-4 py-2 font-semibold text-white" href="/auth">Sign in</Link></div> : null}
