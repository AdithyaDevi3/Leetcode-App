...
export function LocalLearnerSettings() {
  ...
  return <main className="min-h-screen bg-slate-50 px-6 py-8 text-slate-900 sm:py-12"><div className="mx-auto max-w-5xl"><SiteNavigation currentPath="/settings" /><section className="mx-auto mt-10 max-w-2xl rounded-xl bg-white p-6 shadow-sm sm:p-8">
