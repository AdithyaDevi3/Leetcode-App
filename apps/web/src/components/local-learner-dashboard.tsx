...
export function LocalLearnerDashboard() {
  ...
  useEffect(() => {
    const timer = window.setTimeout(() => {
      ...
      setProgress(summarizeLearningProgress(readLocalPracticeHistory()));
    }, 0);
